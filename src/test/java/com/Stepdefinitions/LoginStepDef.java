...

{
	...
	public void user_will_successfuly_able_to_see_sign_in_page(String loginText) throws InterruptedException 
	{
		Assert.assertEquals(Helper.getTitle(), loginText);
		}
	...
	public void user_should_be_successfully_redirected_to_register_page(String registrationText) 
	    {
