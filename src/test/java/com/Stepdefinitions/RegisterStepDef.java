...
public class RegisterStepDef extends BaseClass {
	...
	public void user_enter_the(String username, String password1, String password2) throws Exception {
		rp.sendUsernameText(username); //inputs from feature file examples
	...
	//Register validation with invalid inputs/blank fields
	
	@When("user click register link without entering anything")
	public void user_click_register_link_without_entering_anything(String userName) throws Exception {
		rp.sendUsernameText(userName);
		rp.clickRegisterButton();
	}

	@Then("user should get fillout field error message {string} below username field.")
	public void user_should_get_fillout_field_error_message_below_username_field(String errorMsg) throws InterruptedException {
	...
	public void user_enters_with_username_and_click_on_register_button(String userName, String password) throws Exception {
		rp.sendUsernameText(userName);
	...
	public void user_enters_with_username_and_password_fields_and_click_on_register_button(String password, String password2) throws Exception {
		rp.sendPasswordText1(password);
	    rp.sendPasswordText2(password2);
	    rp.clickRegisterButton();
	}
	...
	public void user_should_get_error_message_password_confirmation(String errorMsg) throws InterruptedException {
		Assert.assertEquals(rp.validationEmptyFieldspassword2(), errorMsg); 
	...
	public void user_should_get_error_message_user_name(String errorMsg) throws InterruptedException {
	...
	public void user_should_get_error_message_under_user_name(String errorMsg) throws InterruptedException {
		Assert.assertEquals(rp.validationEmptyFields(), errorMsg); 
	}
	...
	public void user_will_get_error_message_username(String errorMsg) throws InterruptedException {
		Assert.assertEquals(rp.validationEmptyFields(), errorMsg);
	}
	...
	public void user_should_get_a_password_mismatch_error_message(String errorMsg) throws InterruptedException {
	...
	public void user_should_get_password_atleast_eight_char_error_message(String errorMsg) throws InterruptedException {
	...
	public void user_should_get_enter_valid_input_error_message(String errorMsg) {
	...
	public void user_should_get_password_not_similar_to_username_error_message(String errorMsg) throws InterruptedException {
